        ...
        <div>
            ...
            <div className='about-parent'>
                ...
                <div className='about-child'>
                    ...
                    <p>Embark on a joyous adventure with Whisker World, finding your purr-fect companion. \n Discover the warmth, laughter, and unconditional love a feline friend brings to your home.</p>
                </div>
                    <RandomCat />
                    <h2>😽</h2>
                </div>
